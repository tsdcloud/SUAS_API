...
exports.createParticipantRole = async (req, res) => {
  ...
  try {
    ...
    return ResponseHandler.success(res, participantRoleResponseSerializer(newParticipantRole), 'CREATED');
  } catch (error) {
...
exports.getParticipantRolesInactifs = async (req, res) => {
  ...
  try {
    ...
    const formattedParticipantRoles = participantRoles.map(participantRoleResponseSerializer);
...
exports.getParticipantRole = async (req, res) => {
  ...
  try {
    ...
    return ResponseHandler.success(res, participantRoleDetailResponseSerializer(participantRole));
  } catch (error) {
